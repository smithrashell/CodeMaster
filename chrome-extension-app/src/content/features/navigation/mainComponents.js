/**
 * Component exports for main navigation
 */
...
export const CodeMasterLogo = ({ size = 32, style = {} }) => (
  <svg
    width={size}
    height={size}
...
export const Menubutton = ({ isAppOpen, setIsAppOpen, currPath }) => {
...
export const ProblemLink = ({ currentProblem, problemData, problemFound, loading, problemTitle }) => {
...
export const NavigationSidebar = ({ isAppOpen, setIsAppOpen, currentProblem, problemData, problemFound, loading, problemTitle }) => {
  return (
    <div
      id="cm-mySidenav"
