...
function GoalCard({ goal, progress, onMarkComplete, getGoalIcon, getGoalTypeLabel }) {
  return (
...
function CompletedGoalCard({ goal, getGoalTypeLabel }) {
  return (
...
function EmptyGoalsState({ onCreateGoal }) {
  return (
...
function CreateGoalModal({ isOpen, newGoal, setNewGoal, onClose, onCreate }) {
...
const calculateProgress = (goal, appState) => {
