"use strict";
(self["webpackChunkcodemaster"] = self["webpackChunkcodemaster"] || []).push([["src_shared_hooks_useChromeMessage_js"],{
...
/***/ "./src/shared/hooks/useChromeMessage.js":
/*!**********************************************!*\
  !*** ./src/shared/hooks/useChromeMessage.js ***!
  \**********************************************/
...
/* harmony export */   clearChromeMessageCache: () => (/* binding */ clearChromeMessageCache),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   useChromeMessage: () => (/* binding */ useChromeMessage)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_errorNotifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/errorNotifications */ "./src/shared/utils/errorNotifications.js");
/* harmony import */ var _services_ChromeAPIErrorHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/ChromeAPIErrorHandler */ "./src/shared/services/ChromeAPIErrorHandler.js");
...
var CACHE_TTL = 5 * 60 * 1000; // 5 minutes for real-time balance

// Cache utilities
var getCacheKey = function getCacheKey(request) {
  ...
  }, Object.fromEntries(Object.entries(request || {}).filter(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 1),
      key = _ref2[0];
    return !['timestamp', 'id'].includes(key);
  }))));
};
var getCachedResponse = function getCachedResponse(cacheKey) {
...
var setCachedResponse = function setCachedResponse(cacheKey, data) {
  ...
  if (messageCache.size > 50) {
    var firstKey = messageCache.keys().next().value;
    messageCache["delete"](firstKey);
  }
};

// Clear cache utility for manual refresh
var clearChromeMessageCache = function clearChromeMessageCache(requestType) {
  if (requestType) {
    // Clear specific request type caches
    var _iterator = _createForOfIteratorHelper(messageCache.entries()),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (key.includes("\"type\":\"".concat(requestType, "\""))) {
...
var performanceLogger = {
  logTiming: function logTiming(request, duration, success) {
    var retryCount = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
    var logData = {
      timestamp: new Date().toISOString(),
      requestType: (request === null || request === void 0 ? void 0 : request.type) || 'unknown',
  ...
  logSlowRequest: function logSlowRequest(request, duration) {
    console.warn("\uD83D\uDC0C Slow Chrome Message Request (>".concat(duration, "ms):"), {
      type: request === null || request === void 0 ? void 0 : request.type,
      duration: Math.round(duration),
      request: request,
      timestamp: new Date().toISOString()
  ...
  logFailurePattern: function logFailurePattern(request, error, retryCount) {
...
var handleCacheCheck = function handleCacheCheck(_ref3) {
  var request = _ref3.request,
    bypassCache = _ref3.bypassCache,
  ...
  if (cachedData) {
    console.info("\uD83D\uDE80 Cache hit for ".concat(request === null || request === void 0 ? void 0 : request.type));
    setData(cachedData);
    setLoading(false);
    setError(null);
...
var handleRequestDeduplication = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(_ref4) {
    var request, setData, setLoading, setError, onSuccess, isMountedRef, cacheKey, result, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          request = _ref4.request, setData = _ref4.setData, setLoading = _ref4.setLoading, setError = _ref4.setError, onSuccess = _ref4.onSuccess, isMountedRef = _ref4.isMountedRef;
          cacheKey = getCacheKey(request);
          if (!pendingRequests.has(cacheKey)) {
            _context.n = 5;
            break;
          }
          console.info("\u23F3 Deduplicating request for ".concat(request === null || request === void 0 ? void 0 : request.type));
          _context.p = 1;
          _context.n = 2;
  ...
  return function handleRequestDeduplication(_x) {
    return _ref5.apply(this, arguments);
  };
}();
var handleSuccess = function handleSuccess(_ref6) {
  var response = _ref6.response,
    request = _ref6.request,
    startTime = _ref6.startTime,
    currentRetryCount = _ref6.currentRetryCount,
    cacheKey = _ref6.cacheKey,
    isMountedRef = _ref6.isMountedRef,
    setData = _ref6.setData,
    setLoading = _ref6.setLoading,
    setIsRetrying = _ref6.setIsRetrying,
    setRetryCount = _ref6.setRetryCount,
...
var handleError = function handleError(_ref7) {
  var error = _ref7.error,
    ...
    maxRetries = _ref7.maxRetries,
    showNotifications = _ref7.showNotifications,
    isMountedRef = _ref7.isMountedRef,
    setLoading = _ref7.setLoading,
    setIsRetrying = _ref7.setIsRetrying,
    setError = _ref7.setError,
    setRetryCount = _ref7.setRetryCount,
    onError = _ref7.onError,
    retry = _ref7.retry;
  if (!isMountedRef.current) return;
  var duration = performance.now() - startTime;
  var errorMessage = error.message || "Unknown Chrome extension error";
  ...
  if (showNotifications) {
    (0,_utils_errorNotifications__WEBPACK_IMPORTED_MODULE_1__.showErrorNotification)(errorMessage, {
      title: "Chrome Extension Error",
      message: "Failed to communicate with extension: ".concat(errorMessage),
      ...
      actions: [{
        ...
        label: "Report Issue",
        onClick: function onClick() {
          _services_ChromeAPIErrorHandler__WEBPACK_IMPORTED_MODULE_2__["default"].showErrorReportDialog({
            message: request,
            error: errorMessage,
            attempts: maxRetries,
            duration: Math.round(duration),
 ...
 */
var useChromeMessage = function useChromeMessage(request) {
  ...
  var _options$immediate = options.immediate,
    ...
    _options$showNotifica = options.showNotifications,
    showNotifications = _options$showNotifica === void 0 ? true : _options$showNotifica;
  ...
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    isRetrying = _useState8[0],
    setIsRetrying = _useState8[1];
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    _useState0 = _slicedToArray(_useState9, 2),
    retryCount = _useState0[0],
    setRetryCount = _useState0[1];
  var timeoutRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var retryTimeoutRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    var timeoutRef_current = timeoutRef;
    var retryTimeoutRef_current = retryTimeoutRef;
    return function () {
    ...
    var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            currentRetryCount = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 0;
            bypassCache = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
            if (isMountedRef.current) {
              _context2.n = 1;
              break;
            }
          ...
          case 2:
            _context2.n = 3;
            return handleRequestDeduplication({
              request: request,
              setData: setData,
              setLoading: setLoading,
              setError: setError,
          ...
          case 4:
            ...
            cacheKey = getCacheKey(request);
            requestPromise = _services_ChromeAPIErrorHandler__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessageWithRetry(request, {
  ...
  var retry = function retry() {
    ...
    clearChromeMessageCache(request === null || request === void 0 ? void 0 : request.type);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useChromeMessage);
