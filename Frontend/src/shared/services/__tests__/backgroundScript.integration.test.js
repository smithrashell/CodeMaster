...
const runServiceFailureTests = (simulateGetGoalsDataHandler) => {
...
const runMessageHandlerTests = (simulateGetGoalsDataHandler, mockSendResponse) => {
  describe('Critical: Message Handler Error Boundaries', () => {
    ...
    it('should handle memory pressure scenarios', async () => {
      const largeFocusDecision = {
        ...
        algorithmReasoning: 'x'.repeat(10000),
...
const runChromeContextTests = (simulateGetGoalsDataHandler) => {
...
const runDataFlowTests = (simulateGetGoalsDataHandler, mockSendResponse) => {
...
describe('Background Script - Critical Handler Resilience', () => {
  ...
  runServiceFailureTests(() => simulateGetGoalsDataHandler());
  runMessageHandlerTests(() => simulateGetGoalsDataHandler(), mockSendResponse);
  runChromeContextTests(() => simulateGetGoalsDataHandler());
  runDataFlowTests(() => simulateGetGoalsDataHandler(), mockSendResponse);
});