...
import { calculateAndTrimProblemRelationships, restoreMissingProblemRelationships, storeRelationships, clearProblemRelationships } from "../db/problem_relationships.js";
...
export async function buildProblemRelationships() {
   ...
   console.log("problems", problems)
    ...
    let {updatedProblemGraph, updatedRemovedRelationships} = restoreMissingProblemRelationships({problems, problemGraph, removedRelationships});
