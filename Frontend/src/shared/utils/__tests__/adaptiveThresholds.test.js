...
describe('Adaptive Thresholds System', () => {
  describe('calculateAdaptiveThresholds', () => {
    describe('difficulty context', () => {
      it('should maintain original thresholds with no struggle history', () => {
        ...
        const result = calculateAdaptiveThresholds(baseThresholds, {}, 'difficulty');
      ...
      it('should reduce threshold to 80% after 10+ sessions', () => {
        ...
        const result = calculateAdaptiveThresholds(baseThresholds, struggleHistory, 'difficulty');

        expect(result.adjusted.promotionAccuracy).toBe(0.8);
        expect(result.adaptations).toContain('Moderate struggle: 80% accuracy threshold');
      ...
      it('should reduce threshold to 75% after 15+ sessions', () => {
        ...
        expect(result.adaptations).toContain('Heavy struggle: 75% accuracy threshold');
      });
    });
    ...
    describe('mastery context', () => {
      it('should apply progressive mastery threshold reductions', () => {
        ...
        const result = calculateAdaptiveThresholds(baseThresholds, struggleHistory, 'mastery');

        expect(result.adjusted.masteryThreshold).toBe(0.75); // Light struggle
        expect(result.adaptations).toContain('Light struggle: 75% mastery threshold');
      });
      ...
      it('should apply time-based threshold reduction after 14+ days', () => {
        ...
        expect(result.adaptations).toContain('Time-based: 70% threshold after 2+ weeks');
      });
      ...
      it('should apply extreme struggle threshold after heavy attempts', () => {
        ...
        expect(result.adaptations).toContain('Extreme struggle: 65% mastery threshold');
      });
    });

    describe('expansion context', () => {
      it('should maintain original thresholds with minimal stagnation', () => {
        const baseThresholds = { accuracyThreshold: 0.75, efficiencyThreshold: 0.6 };
        const struggleHistory = { sessionsAtSameTagCount: 2 };
        
        const result = calculateAdaptiveThresholds(baseThresholds, struggleHistory, 'expansion');
      ...
      it('should reduce thresholds after 5+ sessions at same tag count', () => {
        ...
        expect(result.adaptations).toContain('Expansion struggle: 65% accuracy OR 50% efficiency');
      });
      ...
      it('should apply stagnation thresholds after 8+ sessions', () => {
        ...
        expect(result.adaptations).toContain('Expansion stagnation: 60% accuracy OR 40% efficiency');
      });
    });
  });
  ...
  describe('updateStruggleHistory', () => {
    describe('difficulty struggle tracking', () => {
      it('should track sessions at current level', () => {
        ...
        const updated = updateStruggleHistory(history, performanceData, 'difficulty');
    ...
    describe('mastery struggle tracking', () => {
      it('should track consecutive struggles', () => {
        const history = {};
        const performanceData = { mastered: false, attempts: 5, success: false };
        
        const updated = updateStruggleHistory(history, performanceData, 'mastery');
    ...
    describe('expansion struggle tracking', () => {
      it('should track sessions at same tag count', () => {
        ...
        const performanceData = { expanded: false, tagCount: 3, previousTagCount: 3 };
        
        const updated = updateStruggleHistory(history, performanceData, 'expansion');
      ...
      it('should reset count on successful expansion', () => {
        ...
        const performanceData = { expanded: true, tagCount: 4, previousTagCount: 3 };
  ...
  describe('generateAdaptationMessages', () => {
    it('should return empty array when no adaptations', () => {
      const adaptiveThresholds = { adaptations: [], reason: 'No adaptations needed' };
    ...
    it('should generate user-friendly messages for adaptations', () => {
      const adaptiveThresholds = {
        adaptations: ['Heavy struggle: 75% accuracy threshold', 'Time-based: 70% threshold'],
      ...
      expect(messages[0].message).toContain('Heavy struggle: 75% accuracy threshold');
