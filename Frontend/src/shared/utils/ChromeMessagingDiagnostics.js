...
export class ChromeMessagingDiagnostics {
  ...
  async runFullDiagnostics() {
    console.log('🔍 DIAGNOSTICS: Starting comprehensive Chrome messaging diagnostics...');
  ...
  async testMessageHandlers() {
    ...
    return {
      ...
      handlers: results,
      issue: Object.values(results).every(r => !r.success) ? 'No message handlers responding' : null
    };
  }
  ...
  async testDirectDBAccess() {
    console.log('🔍 EMERGENCY: Testing direct IndexedDB access from content script...');
