      ...
      <div className="cd-sidenav__content">
        <div style={{ padding: '8px 12px' }}>
          ...
          <div style={{ 
            ...
            <div style={{ fontSize: '11px', fontWeight: '600', color: 'var(--cd-text)' }}>
          ...
          {focusTags.length > 0 && (
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ 
                ...
                {focusTags.map((tag) => {
                  const tagData = Object.values(tierData).flat().find(t => t.tag === tag);
                  return (
                    <span 
                      key={tag}
            ...
            <div key={tierName} style={{ marginBottom: '16px' }}>
              ...
              <div style={{ 
                ...
                {getVisibleTags(tags, tierName).map((tagData) => {
                  ...
                  const tagClass = getTagClass(tagData.mastery, tagData.unlocked, isFocus);
                  ...
                  return (
                    <span 
                      ...
                      title={`${formatTagName(tagData.tag)} - ${
                        isFocus ? 'Focus Tag' : 
                        !tagData.unlocked ? 'Locked' : 
                        tagData.mastery === 0 ? 'Not Started' :
                        tagData.mastery >= 0.8 ? 'Mastered' : 'Learning'
                      }`}
                    >
          ...
          {Object.entries(tierData).length === 0 && (
            <div style={{ 
              ...
              <p style={{ fontSize: '12px', marginTop: '8px' }}>Start solving problems to see your progress!</p>
            </div>
          )}
          ...
          {expandedTiers.size > 0 && (
            <div style={{ 
              ...
              <div style={{ fontSize: '10px', color: 'var(--cd-text)', opacity: 0.8, marginBottom: '4px', fontWeight: '500' }}>
                Legend:
              </div>
              <div style={{ fontSize: '9px', color: 'var(--cd-text)', opacity: 0.7, lineHeight: '1.3' }}>
