...
export const PAGE_TOURS = {
  ...
  settings: {
    ...
    steps: [
      {
        id: "personalize-codemaster",
        title: "Personalize CodeMaster",
        content: "Customize your CodeMaster experience! Adjust settings to match your learning style and preferences for optimal problem-solving practice.",
        target: null,
        position: "center",
        highlightType: null,
        type: "feature",
      ...
      {
        id: "difficulty-preferences",
        title: "Difficulty & Preferences",
        content: "Set your preferred difficulty levels, problem types, and learning pace. CodeMaster will adapt its recommendations to match your goals.",
        target: ".difficulty-settings, .preferences, [class*='difficulty'], [class*='preference']",
        position: "auto",
        highlightType: "outline",
        type: "feature",
      },
      {
        ...
        content: "Define your learning objectives: interview preparation, skill building, or topic mastery. This helps CodeMaster provide more targeted practice.",
        target: ".goals, .objectives, [class*='goal'], [class*='target']",
        position: "auto",
        highlightType: "spotlight",
        type: "feature",
      },
      {
        ...
        content: "Configure how CodeMaster adapts to your progress: hint frequency, timer preferences, and session length recommendations.",
        target: ".adaptive, .smart-settings, [class*='adaptive'], [class*='auto']",
        position: "auto",
        highlightType: "outline",
        type: "feature",
      },
