...
function getTimeLimitForProblem(problem, limit) {
  if(!problem || !problem.AttemptStats) return limit.Medium;
  console.log(problem.AttemptStats)
  let difficulty = problem.Difficulty/ problem.AttemptStats.TotalAttempts;
  ...
  switch(Rating) {
      ...
      case "Hard":
          return limit.Hard;
      default:
          return limit.Easy; // Safe fallback
  }
}
