...
//TODO : new index on attempt store for  by sessionID
...
// // Helper function to find a problem in the session's problems array
// function findProblemInSession(session, problemData) {
//   return session.problems.find((p) =>
//     p.leetCodeID
...
//   if (existingProblem) {
//     // Update the attemptId if already in session
//     existingProblem.attemptId = attemptId;
//   } else {
//     // Add new problem to session
...
//         addOrUpdateProblemInSession(session, problem, attemptId);
...
//TODO: rewrite getLeetCodeIDAndTags to use standard_problems
